...
def is_sweltering():
    ...
    temp_1 = float(input("What is the current temperature in Fahrenheit? "))
    if temp_1 > 90:
        return True
    else:
        return False
...
def is_warm():
    ...
    """
    # write your code for this function below this line.
    temp_2 = float(input("What is the current temperature in Fahrenheit? "))
    if temp_2 >= 75 and temp_2 <= 87:
        return True
    else:
        return False
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    humid = input("Is it currently humid? ").lower()
    if humid == "yes":
        return True
    else:
        return False
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    forecast = input("What is the weather forecast today? ").lower()
    if forecast == "rain" or forecast == "snow" or forecast == "sleet":
        return True
    else:
        return False
